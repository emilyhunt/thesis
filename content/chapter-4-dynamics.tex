...
\todo{discuss what comes next in the paper from here}
...
\begin{figure}[t]
 ...
 The first step in deriving the photometric mass of a cluster requires calculating the masses of the cluster's member stars. To do so, I follow a common method as used in numerous other works, such as \cite{meingast_extended_2021} and \cite{cordoni_photometric_2023}.

 Firstly, using 100 isochrones for each cluster in our sample, 
...
\begin{figure}[t]
 ...
 \begin{figure}[t]
    ...
    \caption[TODO]{The results of Jacobi radius determination for three candidate new OCs from Paper 2 that were highlighted as example new objects (see Sect.~\ref{c3:sec:discussion-moving_groups} and Fig.~\ref{c3:fig:sus_clusters}). On the top row, cluster }

...
% ---------------------------------------
\section{Open clusters in the pre-\gaia\ era: history and techniques}
...
\subsection{Brand new insights into OCs}
\label{sec:intro:gaia:census}

...
%\part{Example Part}
\input{content/chapter-1-introduction}   % INCLUDE: introduction

%\part{Additional Example Part}
\input{content/chapter-2-detection-methods}
\input{content/chapter-3-census}       % INCLUDE: concepts
\input{content/chapter-4-dynamics}     % INCLUDE: conclusion
\input{content/chapter-5-conclusion}

% --------------------------
% Back matter
% --------------------------
%
\input{content/personal-bibliography} 
...
\input{content/chapter-6-appendix}       % INCLUDE: appendix
